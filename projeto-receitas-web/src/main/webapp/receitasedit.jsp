...
<body>
    ...
    <div class="container" style="padding-left: 200px; padding-right: 200px">
        ...
        <div style="margin-top:10px" class="col">
								...
								<div class="row">
									<div style="display: flex;flex-direction: column;align-items: center;" class="col-6">
										<h4
											...
											Por��es</h4>
										<label style="text-align:center;color: #868e96;font-size:15px">Coloque a quantidade de por��es da receita</label>
								...
								<div
									...
									<h3 style="display: flex; margin-top: 30px; justify-content: center; align-items: center; font-family:'Poppins';font-size: 20px;">Aten��o antes de enviar</h3>
									<br />
								</div>
								<div
									style="display: flex; margin-top: 20px; justify-content: center; align-items: center;">
									<label style="text-align:center;color: #868e96;font-size:15px">
										Revise toda sua receita para que tenha certeza que n�o esta faltando nada.<br />
								...
								<div
									style="display: flex; margin-top: 20px; justify-content: center; align-items: center;">
									<label style="text-align:center;color: #868e96;font-size:15px">
										N�o envie fotos de terceiros, apenas foto de sua autoria.<br />
									</label>
								</div>
								<div
									style="display: flex; margin-top: 20px; justify-content: center; align-items: center;">
									<label style="text-align:center;color: #868e96;font-size:15px">
										As informa��es poder�o ser alteradas caso haja erros.<br />
									</label>
								</div>
								<div
									style="display: flex; margin-top: 20px; justify-content: center; align-items: center;">
    ...
    margin-top: 2px;" type="submit" value="Concluir Edi��o" />
								</div>
